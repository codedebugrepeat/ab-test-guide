export const vocabulary = {
  ...
  "variability": "We use the standard deviation (sd) to measure variaiblity. The sd is the typical width of a sampling distribution. One standard deviation from the mean captures roughly 68% of samples; two captures about 95%.",
